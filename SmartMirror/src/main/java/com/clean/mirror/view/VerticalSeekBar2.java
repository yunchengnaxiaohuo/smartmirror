...
public class VerticalSeekBar2 extends AbsSeekBar {
	 private int height = -1;  
	    ...
	    {  
	        public void onProgressChanged(VerticalSeekBar2 vBar, int progress,boolean fromUser);  
	        public void onStartTrackingTouch(VerticalSeekBar2 verticalSeekBar2);  
	        public void onStopTrackingTouch(VerticalSeekBar2 vBar);  
	    }  
