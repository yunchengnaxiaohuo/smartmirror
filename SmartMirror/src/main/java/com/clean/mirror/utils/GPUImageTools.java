...
import com.clean.mirror.R;
import com.clean.mirror.gpuutils.GPUImageSepiaFilter;
import com.clean.mirror.gpuutils.GPUImageSobelEdgeDetection;
...
public class GPUImageTools {  
    public static FilterList getFilterList(final Context context,
...
//        builder.create().show();
    ...
    public static class FilterList {
    	public Map<String, FilterType> hmfilter=new HashMap<String, GPUImageTools.FilterType>();
        public List<String> names = new LinkedList<String>();
        public List<FilterType> filters = new LinkedList<FilterType>();

        public void addFilter(final String name, final FilterType filter) {
        	hmfilter.put(name, filter);
            names.add(name);
            filters.add(filter);
        }
    }
